...
import globalFeaturesSlice from './slice/globalFeaturesSlice';
...
const reducers = combineReducers({
  ...
  globalFeatures: globalFeaturesSlice,
});
...
const persistConfig = {
  ...
  whitelist: [
    'auth',
    'user',
    // user preferences + entitlements
    'nightMode',
    'subscription',
    // user-specific selections/state
    'frequencyQueue',
    'volume',
    'savedFrequencies',
    'savedVideos',
    'voiceGuide', // persists curated voice list so it survives cold restarts
  ],
  // catálogos (mood/frequency/guides/etc.) ficam fora do persist para reduzir reidratação
};
