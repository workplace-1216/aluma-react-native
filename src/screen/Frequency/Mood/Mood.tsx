...
const Mood: React.FC = () => {
  ...
  useEffect(() => {
    logAudioEvent({
      action: 'moodScreenMounted',
      route: routes.MOOD,
      callsite: 'Mood.lifecycle',
      payload: {
        moodId: mood?._id,
      },
    });
  ...
  const handlePlay = useCallback(
    (item: FREQUENCY) => {
      logAudioEvent({
        action: 'moodHandlePlay',
        route: routes.MOOD,
        callsite: 'Mood.handlePlay',
        payload: {
          moodId: mood?._id,
          frequencyId: item._id,
        },
      });
  ...
  const handleAllInOneListening = useCallback(
    (minutes: number, seconds: number) => {
      ...
      logAudioEvent({
        action: 'moodStartAllInOne',
        route: routes.MOOD,
        callsite: 'Mood.handleAllInOneListening',
        payload: {
          moodId: mood?._id,
          frequencies: list.length,
    ...
    [dispatch, mood?.frequencies, mood?._id]
  );
